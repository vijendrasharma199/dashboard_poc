...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    //   compass['dir'].value = angle as double;
    //   earth['dir'].value = angle as double;
    // });
      ...
      children: [
        ...
        Expanded(
          child: GestureDetector(
            ...
            onDoubleTap: locate,
            onPanUpdate: (pan) =>
                setLocation((lat - pan.delta.dy).clamp(-90.0, 90.0), (lon - pan.delta.dx + 180) % 360 - 180, false),
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            SizedBox(width: 128, height: 128, child: FlareActor('assets/weather.flr', animation: icon)),
            Column(
